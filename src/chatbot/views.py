...
def ai_chat(request):
    if request.method == "POST" and request.headers.get("x-requested-with") == "XMLHttpRequest":
        ...
        headers = {
            "Authorization": "Bearer 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",
        ...
        if api_response.status_code == 200:
            ...
            return JsonResponse({"response": "حدث خطأ أثناء الاتصال بـ OpenRouter."})
